...
indexofcols=[8 53 103 167 215 272 289]
...
edgebetas=csvread(fullfile(clustcodir,'edge_betas_agexses_int_scaled_small_sample_cont_ses.csv'),1, 1 );
%edgebetas(:,1)=[]
...
%make a matrix of everything outside the 26 nodes of significance)
    ...
    nonsigedgesonly=nodesandedges([8:359],[8:359]);
